    ...
    const generateAllRentGarbage= (e)=>{
        ...
        .then((willcontinue) =>{
            if(willcontinue){
                ...
                axios.post('/v2/generate/rentgarbage/all',form)
                .then(response=>{
                    if(response.data.status=== 200){
                        loadRentGarbage();
    ...
    const generateSelectedRentGarbage= (e)=>{
        ...
        .then((willcontinue) =>{
            if(willcontinue){
                setLoading(true);
                Swal("Generating....","Please Wait");
                axios.post('/v2/generate/rentgarbage/selected',form)
                .then(response=>{
                    if(response.data.status=== 200){
                        loadRentGarbage();
                        Swal("Success",response.data.message);
                                            ...
                                            <div className="card-header bg-info text-white elevation-2 m-0 p-0">
                                                <p className='text-center p-1 m-0'>
                                                    ...
                                                    <span>
                                                        ...
                                                        {!loadingwater &&
                                                            <>
                                                                Monthly Bills for {waterbillpropertyid.label!==undefined && waterbillpropertyid.label+" "+waterbillmonth.label} 
                                                                {/* {preview && 
