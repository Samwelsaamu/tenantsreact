...
function MonthlyLeasesTable({waterbill,no,handleShow,uploadwaterbill,allchecked,handleChange,showcheckhouse,showchecktenant}) {
...
export default MonthlyLeasesTable;