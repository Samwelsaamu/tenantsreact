  ...
  return (
    <tr className={`unwaterbillvaluesdiv m-0 p-0 ${(uploadwaterbill.upwaterbill.filter( (f) => f === waterbill.id+'?'+waterbill.housename+'?'+waterbill.tid+'?'+waterbill.tenantname+'?'+waterbill.pid+'?'+waterbill.paymentid+'?')).length ?'bg-secondary text-info':(waterbill.saved=='No'?'bg-light text-dark':'bg-warning text-dark')}`}
      key={no} >
        ...
        <td className={`m-0 p-1 ${(uploadwaterbill.upwaterbill.filter( (f) => f === waterbill.id+'?'+waterbill.housename+'?'+waterbill.tid+'?'+waterbill.tenantname+'?'+waterbill.pid+'?'+waterbill.paymentid+'?')).length ?'bg-secondary text-info':(waterbill.saved=='No'?'bg-light text-dark':'bg-warning text-dark')}`}>{new Number(waterbill.Rent).toFixed(2)}</td>
        <td className={`m-0 p-1 ${(uploadwaterbill.upwaterbill.filter( (f) => f === waterbill.id+'?'+waterbill.housename+'?'+waterbill.tid+'?'+waterbill.tenantname+'?'+waterbill.pid+'?'+waterbill.paymentid+'?')).length ?'bg-secondary text-info':(waterbill.saved=='No'?'bg-light text-dark':'bg-warning text-dark')}`}>{new Number(waterbill.Garbage).toFixed(2)}</td>
        <td className={`m-0 p-1 ${(uploadwaterbill.upwaterbill.filter( (f) => f === waterbill.id+'?'+waterbill.housename+'?'+waterbill.tid+'?'+waterbill.tenantname+'?'+waterbill.pid+'?'+waterbill.paymentid+'?')).length ?'bg-secondary text-info':(waterbill.saved=='No'?'bg-light text-dark':'bg-warning text-dark')}`}>{new Number((waterbill.Rent)+(waterbill.Garbage)).toFixed(2)}</td>
