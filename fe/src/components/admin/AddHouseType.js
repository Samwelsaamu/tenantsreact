...
function AddHouseType({show, handleClose,currentproperty,propertydata,loadPropertyHouseTypes,loadHouses}) {
    ...
    const deletePropertyHouseType= (type)=>{
        ...
        let text="This will remove this House Type.";
        Swal({
            title:title+' ?',
            text:text,
            buttons:true,
            ...
            <>
                <Modal.Header className='justify-content-center bg-warning m-0 p-2' closeButton>
                    <Modal.Title className='mx-auto text-dark text-sm'> 
                        <h5>Update House Type : {currenthouse.typename}</h5>
                    </Modal.Title>
                </Modal.Header>
            </>
            }
