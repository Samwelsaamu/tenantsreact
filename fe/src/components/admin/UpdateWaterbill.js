...
function UpdateWaterbill(props) {
    ...
    const loadWaterbill =() =>{
        ...
        const getWaterbill = async (e) => { 
            ...
            await axios.get(`/v2/update/waterbill/load/${id1}/${month}`)
            .then(response=>{
                if (doneloading) {
    ...
    const loadWaterbills =(msg) =>{
        ...
        const getWaterbill = async (e) => { 
            ...
            await axios.get(`/v2/update/waterbill/load/${id1}/${msg}`)
            .then(response=>{
                if (doneloading) {
                    if(response.data.status=== 200){
                    ...
                    <div className="container">
                                        ...
                                        <div className="card-body text-center p-0 m-1">
                                            <div className="row m-0 p-0">
                                                ...
                                                <div className="col-md-12 m-0 mt-1 p-1">
                                                    ...
                                                    {!loadingmonths && !loadingwater && !acceptedFiles[0] && 
                                                        <>
                                                            {id!=='' &&
                        ...
                        <div className="col-lg-9">
                            <div className="row m-0 p-0">
                                ...
                                {show && 
                                    <AddWaterbill show={show} handleClose={handleClose} currentwaterbill={currentwaterbill} setMonth={setMonth} loadWaterbill={loadWaterbill}/>
                                }
