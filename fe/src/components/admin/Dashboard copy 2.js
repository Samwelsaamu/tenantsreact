                        ...
                        <div className="col-lg-8">
                            <div className="row m-0 p-0">
                                                    ...
                                                    <div className='col-4 col-lg-2 col-md-3 m-0 p-0  mb-1 text-center'>
                                                        <div className='m-0 p-0 mr-2 border-white-b '>
                                                            <div>
                                                                ...
                                                                <div className='bold text-primary text-sm p-0'>
                                                                    {loadingtotalproperties &&
                                                                        <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                                    }
                                                                    {selectedmonth !== '' &&
                                                                ...
                                                                <div className='bold text-lime text-sm p-0'>
                                                    ...
                                                    <div className='col-4 col-lg-2 col-md-3 m-0 p-0  mb-1 text-center'>
                                                        <div className='m-0 p-0 mr-2 border-white-b '>
                                                            <div>
                                                                ...
                                                                <div className='bold text-lime text-sm'>
                                                                    <span className='text-dark text-xs'>{!loadingmonths && prevmonths && " "+prevmonths[selectedmonth].monthname}: </span>
                                ...
                                <div className="col-md-12 m-0 p-0 mb-4 justify-content-center">
                                    ...
                                    {selectedmonth !== '' &&  (totalrent) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Rent:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalrent &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                                        {selectedmonth !== '' &&
                                    ...
                                    {selectedmonth !== '' &&  (totalrentd) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Rent D:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalrentd &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalwaterd) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Waterbill:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalwaterd &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalwaterd) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Water D:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalwaterd &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalgarbage) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Garbage:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalgarbage &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalkplcd) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>KPLC D:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalkplcd &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalforwaded) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Carried:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                    ...
                                    {selectedmonth !== '' &&  (totallease) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Leases:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotallease &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalbilled) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Billed:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalbilled &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalpaid) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Paid:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalpaid &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalbalance) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>Balance:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalbalance &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                    ...
                                    {selectedmonth !== '' &&  (totalrefund) >0 &&
                                        <div className='col-6 col-lg-3 col-md-3 m-0 p-0 text-left'>
                                            <div className='m-0 p-0 mr-2 border-white-b '>
                                                <div className='elevation-1 p-1 border-light'>To Refund:
                                                    <span className='float-right bold p-1 text-info text-sm'>
                                                        {loadingtotalrefund &&
                                                            <Spinner  variant="info" size="sm" role="status"></Spinner>
                                                        }
                                ...
                                <div className="row m-0 p-0">
                                    ...
                                    <div className="col-12 col-lg-6 m-0 p-0 mt-2 mb-4">
                                        <div className="card-body text-center m-0 mb-3 p-0">
                                            <div className='text-md bold text-center weight-bold'>
                                                Payments  
                                                {loadingmonths &&
                                                    <Spinner  variant="info" size="sm" role="status"></Spinner>
