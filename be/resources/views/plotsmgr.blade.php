...
@section('sidebarlinks')
  ...
  <li class="nav-item menu-open">
    ...
    <ul class="nav nav-treeview bg-primary">
      ...
      <li class="nav-item">
        <a href="/properties/manage" class="nav-link active">
                    ...
                    <div class="m-0 mb-2 text-xs">
                      <div class="card-body m-0 p-0">
                        ...
                        <div class="card m-0 p-0 mb-2">
                          ...
                          <div class="card-body m-1 p-1 propertiesmanagesideproperty" style="overflow-x:auto;max-height: 100vh;overflow-y:auto;">
                        ...
                        <!-- <div class="card m-0 p-0 mb-2">
                          ...
                          <div class="card-body m-1 p-1 propertiesmanagesidetenant" style="overflow-x:auto;max-height: calc(50vh - 10rem);overflow-y:auto;">
        ...
        '<form role="form" name="seachedhousesform" id="seachedhousesform" class="form-horizontal" action="/updatehouse" method="post" enctype="multipart/form-data">'+
              ...
              '<thead>'+
                '<tr style="color: #77B5ED;">'+
                  ...
                  '<th class="m-0 p-1">Bin</th>'+
                  '<th class="m-0 p-1">Due</th>'+
                  '<th class="m-0 p-1">Status</th>'+
                  '<th class="m-0 p-1">Action</th>'+
                '</tr>'+
              '</thead>'+
