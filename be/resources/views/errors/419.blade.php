...
<head>
    ...
    <title>Logged In Session ds Expired</title>
    ...
    <div id="app">
        ...
        <main class="" style="padding-top: 80px;min-height: calc(100vh - 3rem);">
            <div class="text-center">
              <h2 class="text-danger text-center">You Have Been Logged Out</h2>
              <li class="nav-item">
                  <a class="nav-link" href="/login"><button class="btn btn-flat btn-primary"> <i class="fa fa-arrow-left"></i> {{ __('Login Again') }}</button></a>
              </li>
          </div>
        </main>
