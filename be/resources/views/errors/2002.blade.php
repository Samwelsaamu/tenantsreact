    ...
    <div id="app">
        ...
        <main class="" style="padding-top: 80px;min-height: calc(100vh - 3rem);">
            <div class="text-center">
              <h2 class="text-danger text-center">No Resource or file found</h2>

              <li class="nav-item">
                  <a class="nav-link" href="/home"><button class="btn btn-flat btn-primary"> <i class="fa fa-arrow-left"></i> {{ __('Back to Home') }}</button></a>
              </li>
          </div>
        </main>
