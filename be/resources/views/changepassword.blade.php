...
@section('title','Change Password | Wagitonga Agencies Limited')
@section('HeaderTitle')
<div class="col-sm-6">
    <h1 class="m-0">Change Password Information</h1>
</div><!-- /.col -->
<div class="col-sm-6">
            ...
            <div class="card" style="border: none;">
                ...
                <div class="card-body" style="padding-top: 10px;">
                        ...
                        <div class="col-sm-8">
                          ...
                          <div class="row">
                    <div class="col-sm-12">
                            <form role="form" class="form-horizontal" method="post" action="{{ route('agreement.update',Auth::user()->id) }}">
                                @csrf
                                @method('PATCH')
